<!--
This is the committed spec-kit evidence artifact (PHASE-0 §8, gate 0.5). It is kept byte-identical
to .specify/memory/constitution.md, which is the copy the speckit-* skills read and update at
runtime. If the two ever diverge, .specify/memory/constitution.md is live and this file is stale —
re-copy it before trusting this one.
